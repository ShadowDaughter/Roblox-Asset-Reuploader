 ...
 */
export const ensureResourcesDirectory = async (): Promise<void> => {
    try {
 ...
 */
export const generateLogsFile = async (): Promise<void> => {
    try {
 ...
 */
export const appendToLogFile = (message: string): void => {
 ...
 */
export const generateEnvFile = async (): Promise<void> => {
    try {
        await ensureResourcesDirectory();
